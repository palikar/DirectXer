...
static void ParseCommandLineArguments(int argc, char *argv[], BVHVisualizer::CommandLineArguments& arguments)
{
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdSHow)
{
	...
	windowClass.lpszClassName = "BVHVis";
	...
	context.hWnd = CreateWindow("BVHVis", "BVH Visualizer", context.WindowStyle,
