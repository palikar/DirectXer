...
static int AxisHelperData(ColorVertex* t_Vertices, TempVector<uint32>& t_Indices)
{
...
static int CameraHelperData(CameraHelper t_Camera, ColorVertex* t_Vertices, TempVector<uint32>& t_Indices)
{
...
static int PointLightHelperData(ColorVertex* t_Vertices, TempVector<uint32>& t_Indices, uint32 t_BaseIndex = 0)
{
...
static int SpotLightHelperData(SpotLightHelper t_SpotLight, ColorVertex* t_Vertices, TempVector<uint32>& t_Indices, uint32 t_BaseIndex = 0)
{
